...
public class Baltika9Beer extends BlockContainer {
    private static String name = "beer";
    private static Block top;

    public Baltika9Beer(String name, String textureName, Block top, int doRegister) {
    ...
    public Baltika9Beer(String name, String textureName, int doRegister) {
        super(Material.glass);
        this.name = name;
        this.top = top;
        if(textureName == null){
    ...
    public Baltika9Beer(String name) {
        super(Material.glass);
        this.name = name;
        setBlockName(name);
