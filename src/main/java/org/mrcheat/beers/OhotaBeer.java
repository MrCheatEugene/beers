...
public class OhotaBeer extends BlockContainer {
    private static String name = "beer";
    private static Block top;

    public OhotaBeer(String name, String textureName, Block top, int doRegister) {
    ...
    public OhotaBeer(String name, String textureName, int doRegister) {
        super(Material.glass);
        this.name = name;
        this.top = top;
        if(textureName == null){
